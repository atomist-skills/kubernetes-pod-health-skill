...
describe("K8sPodState", () => {
    ...
    describe("handler", () => {
                ...
                configuration: [
                    {
                        ...
                        parameters: {
                            ...
                            intervalMilliseconds: 86400000,
                            maxRestarts: 10,
                            notReadyDelayMilliseconds: 600000,
                            notScheduledDelayMilliseconds: 600000,
                            restartsPerDay: 1,
        ...
        it("ignores exceeding allowable restart rate on young pod", async () => {
            const age = ageString(new Date(new Date().getTime() - 10 * 60 * 1000));
            const d = {
                K8Pod: [
                    {
                        baseName: "restart",
